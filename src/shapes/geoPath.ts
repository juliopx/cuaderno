...
// Use the exported STROKE_SIZES if available, otherwise define our own matching tldraw's
// In GeoShapeUtil.mjs it was imported from ../shared/default-shape-constants.mjs
...
function _getGeoPath(shape: TLGeoShape) {
  ...
  switch (shape.props.geo) {
    ...
    default:
      exhaustiveSwitchError(shape.props.geo as never, 'geo')
  }
}
