...
export class PathBuilder {
  ...
  toDrawD(opts: DrawPathBuilderDOpts) {
    ...
    for (let i = 0; i < this.commands.length; i++) {
      ...
      const currentSupportsRoundness = commandsSupportingRoundness[command.type as keyof typeof commandsSupportingRoundness]
      const nextSupportsRoundness =
        nextIdx !== undefined ? commandsSupportingRoundness[this.commands[nextIdx].type as keyof typeof commandsSupportingRoundness] : false
