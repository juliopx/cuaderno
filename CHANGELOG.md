...
### Features
* Added sidebar contextual menus for item management (rename, duplicate, delete) and a new compressed export/import system using `.cua` and `.pag` extensions. (#111)
...
**Full Changelog**: https://github.com/juliopx/cuaderno/compare/v1.7.1...v1.10.0
